            ...
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="stickyheader" id="myHeader">
                        <!-- <img class="img-responsive img-full" src="img/bg_head_middle.jpg" alt="" > -->
...
<iframe src="https://blog.hairofthearts.com/category/testimonials" title="HOTA Online Blog" width="100%" height="725px">

</iframe>
                   
                    <h2 class="intro-text text-center">Contact:<strong>Bryan at Hair of the Arts</strong></h2>
                    <a href="https://blog.hairofthearts.com/admin" target="_blank">Blog Administration</a>
